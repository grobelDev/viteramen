...
export default function Testimonials() {
  return (
    <div>
      <div class='py-12 bg-gray-50 overflow-hidden md:py-20 lg:py-20'>
          ...
          <div class='relative'>
            ...
            <blockquote class='mt-8'>
              <div class='max-w-3xl mx-auto text-center text-2xl leading-9 font-medium text-gray-900'>
                <p>
                  “As a Registered Dietitian Nutritionist, I love everything
                  about it! For anyone wanting a quick, nutritious meal, this is
                  the real deal.”
                </p>
              </div>
              <footer class='mt-8'>

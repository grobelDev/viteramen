      ...
      <div class='max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8'>
        <div class='xl:grid xl:grid-cols-3 xl:gap-8'>
          <div class='xl:col-span-1'>
            ...
            <p class='mt-8 text-gray-500 text-base leading-6'>
              The Future of Food is Nutritionally Complete.
            </p>
            <div class='mt-8 flex'>
              <a
                href='https://www.facebook.com/viteramen/'
              ...
              <a
                href='https://www.instagram.com/viteramen/'
              ...
              <a
                href='https://twitter.com/viteramen'
                class='ml-6 text-gray-400 hover:text-gray-500'
              >
            ...
            <div class='md:grid md:grid-cols-2 md:gap-8'>
              <div>
                ...
                <ul class='mt-4'>
                  <li>
                    <a
                      href='https://shop.viteramen.com/collections'
                  ...
                  <li class='mt-4'>
                    <a
                      href='https://shop.viteramen.com/pages/special-service'
                      class='text-base leading-6 text-gray-500 hover:text-gray-900'
                    >
            ...
            <div class='md:grid md:grid-cols-2 md:gap-8'>
              <div>
                ...
                <ul class='mt-4'>
                  <li>
                    <a
                      href='https://www.viteramen.com/shipping-and-returns/#risk-free'
                      class='text-base leading-6 text-gray-500 hover:text-gray-900'
                    >
                  ...
                  <li class='mt-4'>
                    <a
                      href='https://www.viteramen.com/shipping-and-returns/#shipping-returns'
                      class='text-base leading-6 text-gray-500 hover:text-gray-900'
                    >
                  ...
                  <li class='mt-4'>
                    <a
                      href='https://shop.viteramen.com/policies/privacy-policy'
                      class='text-base leading-6 text-gray-500 hover:text-gray-900'
                    >
                      Privacy Policy
                    </a>
                  ...
                  <li class='mt-4'>
                    <a
                      href='https://shop.viteramen.com/policies/terms-of-service'
                      class='text-base leading-6 text-gray-500 hover:text-gray-900'
                    >
                      Terms of Service
                    </a>
              ...
              <div class='mt-12 md:mt-0'>
                ...
                <ul class='mt-4'>
                  <li class='text-base leading-6 text-gray-500 hover:text-gray-900'>
                    Need to tell us something? Ring us up at shop@viteramen.com!
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class='mt-12 border-t border-gray-200 pt-8'>
          <p class='text-base leading-6 text-gray-400 xl:text-center'>
            &copy; 2020 Vite Ramen. All rights reserved.
          </p>
        </div>
      </div>
    </div>
